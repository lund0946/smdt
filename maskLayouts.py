...
#    "lris": ((-107.95, -167.8, 0), (107.95,-167.8,1), (107.95, 167.8, 1), (-107.95, 167.8, 1), (-100, 100, 2) ),
#    "lris": ((-107.95, -167.8, 0), (107.95,-167.8,1), (107.95, 167.8, 1), (-107.95, 167.8, 1), (-100, 100, 2) ),
    "lris": ((-107.95+305, -167.8, 0), (107.95+305,-167.8,1), (107.95+305, 167.8, 1), (-107.95+305, 167.8, 1), (-107.95+305, -167.8, 2) ),
##    "lris": ((172.7, 177.8, 0), (437.3,177.8,1), (437.3, -86.8, 1), (172.7, -86.8, 1), (172.7, 177.8, 2) ),

    "lrismm": ((3.175, 3.175, 0), (352.425,3.175,1), (352.425, 261.493, 1), (3.175, 261.493, 1), (3.175, 3.175, 2) ),


}

#    "lris": ((-200, -200, 0), (200,-200,1), (200, 200, 1), (-200, 200, 1), (-100, 100, 2) ),
#     :           NOTCH1X = 172.67,
#     :           NOTCH1Y = 152.40,
#     :           NOTCH2X = 350.47,
#     :           NOTCH2Y = 177.80)
...
def lrismcs (layout):
    return [ ((0-y)+177.8, (x-305)+132.3, t) for x, y, t in layout]
